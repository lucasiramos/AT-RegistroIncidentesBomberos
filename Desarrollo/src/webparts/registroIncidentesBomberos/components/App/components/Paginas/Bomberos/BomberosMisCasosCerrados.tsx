...
import { DataMisSiniestrosCerrados } from '../../EstructuraApp/DatosPrueba/Datos'
...
export const BomberosMisCasosCerrados: React.FunctionComponent<{}> = ({children}: any) => {
    ...
    return (
        <>
            <PrimeReactProvider>
                <DataTable value={DataMisSiniestrosCerrados} size="small" paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '50rem' }}>
